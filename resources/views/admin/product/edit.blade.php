    ...
    <div class="col-12">
        <div class="card customize-card customize-card-2">
            ...
            <div class="card-body card-body-customize px-2">
                <div class="class">
                    <form action="{{ route('product.update',['id' => $product->id]) }}" method="post" enctype="multipart/form-data" id="updataProduct">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control cate-Select2" name="cate_id">
                                            ...
                                            <option {{ $product->cate_id == $cate['id'] ? 'selected' : '' }} value="{{$cate['id']}}">{{$cate['name']}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="origin">
                                            ...
                                            <option {{$product->origin_id == $origin->id ? 'selected' : ''}} value="{{$origin->id}}">{{$origin->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="intro" value="" class="ckeditor" id="intro" rows="10" cols="130">
                                                {!! $product->intro !!}
                                         </textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="base_price" value="{{ old('base_price') ?? $product->base_price }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" name="status">
                                        ...
                                        <option {{$product->status == $status['id'] ? 'selected' : ''}} value="{{ $status['id'] }}">{{ $status['name']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" name="state">
                                        ...
                                        <option {{ $product->state == $sta['id'] ? 'selected': '' }} value="{{ $sta['id'] }}">{{ $sta['name'] }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group text-center mb-4">
                                    ...
                                    <div class="main-img-preview img-holder">
                                        ...
                                        <img class="thumbnail img-preview " src="{{ $product->image->path ?? asset('font-icon/image-icon.png')  }} " width="100">
                                    </div>
...
<script>
    $('#updataProduct').on('submit', function(e) {
        e.preventDefault();
