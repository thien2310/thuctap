    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('{{ asset('Login_v4/images/bg-01.jpg') }}')">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form " action="{{ route('auth.HandleSingup')}}" method="post">
                    @csrf
                    ...
                    <div class="wrap-input100 m-b-23" data-validate="">
                        <input class="input100" type="text" name="name" placeholder="Tên người dùng">
